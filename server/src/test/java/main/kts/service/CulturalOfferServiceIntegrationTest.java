...
//	}
	...
	public void testCombinedSearch() {
		...
		Page<CulturalOffer> found = culturalOfferService.findByCombinedSearch(pageable, DB_CONTENT, DB_CITY);
		assertEquals(DB_SIZE_BY_COMBINED_SEARCH, found.getNumberOfElements());
	}
