...
public class ImageConstants {
	...
	public static final String NEW_IMAGE_NAME = "name";
	public static final String NEW_IMAGE_RELATIVE_PATH = "path1.jpg";
	public static final String UPDATED_IMAGE_RELATIVE_PATH = "path2.jpg";
    ...
    public static final int DB_SIZE_PAGABLE = 7;
    public static final Long DB_FALSE_IMAGE_ID = 11L;
	...
	public static final Long DELETE_ID = 8L;
	public static final String IMAGE_NAME_NEW = "arcade";
	public static final String IMAGE_REL_PATH_NEW = "arcade.jpg";
}
