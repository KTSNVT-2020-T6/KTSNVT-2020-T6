...
public class RegisteredUserController {
	...
	public ResponseEntity<List<RegisteredUserDTO>> getAllRegUsers(){
		List<RegisteredUser> admins = service.findAll();
...
//    }
	...
	public ResponseEntity<Integer> getAllInterestedUsers(@PathVariable Long id) {
    	...
    	if(co == null)
    		return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
		List<Long> users = service.findByIdCO(id);
	...
	private boolean validate(RegisteredUserDTO registeredUserDTO) {
		...
		if(registeredUserDTO.getFirstName() == null || registeredUserDTO.getFirstName().isEmpty())
			return false;
		if(registeredUserDTO.getLastName() == null || registeredUserDTO.getLastName().isEmpty())
			return false;
		
		if(registeredUserDTO.getEmail() == null || registeredUserDTO.getEmail().isEmpty())
			return false;
		if(registeredUserDTO.getPassword() == null || registeredUserDTO.getPassword().isEmpty())
			return false;
