...
public class AuthenticationController {
    ...
    public ResponseEntity<?> addUser(@RequestBody RegisteredUserDTO registeredUserDTO, HttpServletRequest request) throws Exception {
        ...
        try {
        	...
        	registeredUser = regUserMapper.toEntity(registeredUserDTO);
        ...
        return new ResponseEntity<>(regUserMapper.toDto(registeredUser), HttpStatus.CREATED);
    }
    ...
    private boolean validate(UserDTO adminDTO) {
