...
import main.kts.security.auth.RestAuthenticationEntryPoint;
import main.kts.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
       ...
       // web.ignoring().antMatchers(HttpMethod.GET, "/api/cultural-offer/find/subscriptions");
        ...
        web.ignoring().antMatchers(HttpMethod.GET, "/api/cultural-offer/combined/**");
        ...
        web.ignoring().antMatchers(HttpMethod.GET, "/api/rate/");
        web.ignoring().antMatchers(HttpMethod.GET, "/api/rate/{id}");
