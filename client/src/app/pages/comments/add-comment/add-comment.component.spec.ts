...
describe('AddCommentComponent', () => {
  ...
  it('should map on form', fakeAsync(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      const text = fixture.debugElement.nativeElement.querySelector('#newComment');
      ...
      fixture.detectChanges(); //
      const controlTextInput = fixture.debugElement.query(By.css('#newComment')).nativeElement;
      expect(controlTextInput.value).toEqual('Tekst komentara');
      const controlText = component.commentForm.controls.text;
  ...
  it('should add comment with image', fakeAsync(() => {
    ...
    spyOn(component, 'onFileSelect').and.callFake(() => {});
