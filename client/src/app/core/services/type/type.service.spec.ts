...
describe('TypeService', () => {
    ...
    it('should throw error on get all types', () => {
        ...
        let errorr = '';
        typeService.getAll().subscribe({error: (e) => errorr = e.statusText});
        const req = httpMock.expectOne('https://localhost:8443/api/type');
        expect(req.request.method).toBe('GET');
    ...
    it('should throw error on get types of category', () => {
        ...
        let errorr = '';
        typeService.getTypesOfCategory(1).subscribe({error: (e) => errorr = e.statusText});
        const req = httpMock.expectOne('https://localhost:8443/api/type/category/1');
        expect(req.request.method).toBe('GET');
        req.flush('Error on server', {
          status: 404,
    ...
    it('should throw error on add type', () => {
        ...
        let errorr = '';
        typeService.add(newType).subscribe({error: (e) => errorr = e.statusText});
        const req = httpMock.expectOne('https://localhost:8443/api/type');
        expect(req.request.method).toBe('POST');
        req.flush('Error on server', {
          status: 404,
    ...
    it('should throw error on get type', () => {
        ...
        let errorr = '';
        typeService.getType(1).subscribe({error: (e) => errorr = e.statusText});
        const req = httpMock.expectOne('https://localhost:8443/api/type/1');
        expect(req.request.method).toBe('GET');
        req.flush('Error on server', {
          status: 404,
    ...
    it('should throw error on update type', () => {
        ...
        let errorr = '';
        typeService.update(type, 1).subscribe({error: (e) => errorr = e.statusText});
        const req = httpMock.expectOne('https://localhost:8443/api/type/1');
        expect(req.request.method).toBe('PUT');
        req.flush('Error on server', {
          status: 404,
    ...
    it('should throw error on delete type', () => {
        let errorr = '';
        typeService.delete(1).subscribe({error: (e) => errorr = e.statusText});
        const req = httpMock.expectOne('https://localhost:8443/api/type/1');
        expect(req.request.method).toBe('DELETE');
        req.flush('Error on server', {
          status: 404,
