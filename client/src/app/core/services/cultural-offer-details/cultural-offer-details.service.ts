...
export class CulturalOfferDetailsService {
  ...
  getOne(id: any): Observable<any> {
    ...
    edit(newCulturalOffer: CulturalOffer): Observable<any> {
        return this.http.put(`${environment.baseUrl}/${environment.culturalOffer}/${newCulturalOffer.id}`
        , newCulturalOffer, {headers: this.headers, responseType: 'json'});
    }
    ...
    searchCombined(page: number, size: number, content: string, city: string): Observable<any> {
        ...
        return this.http.get(`${environment.baseUrl}/${environment.culturalOffer}/combined/${content}_${city}`,
